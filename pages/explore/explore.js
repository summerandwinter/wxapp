  ...
  initData2:function(){
   ...
   var data = [

     {
       ...
       "time": "17小时前",
       "shares": 0,
       "content": "真的爱有时候抓不来 伪装的总赚不到关怀 要是活下来 初心不再 如何在迷雾 走出个未来 不希望活得荒凉苍白 门打开 保护膜褪下来 就像把洋葱剥开",
       ...
       "time": "21小时前",
       "shares": 0,
       "content": "野风吹乱月光 生如逐放 心有焰藏 谁人笑我卑伧 被命运折断了翅膀 坠落深渊万丈 记忆被封藏 这风雪多嚣张 就算再被践踏也不仰望 我会越挫越强 这呼吸是热 这心跳是光 一点一滴酝酿一生一世的较量 我眼中滚烫 点燃这希望 无论多少伤 我愿燃尽心焰照四方 融化人世间冰霜 只要明月知道我所想 长路永夜又怎样 我要漫天心焰再滚烫 烧出天边一道光 浴火重生天地尽芬芳 彼岸再盛放 烧出天边一道光 彼岸再盛放",
       ...
       "time": "1小时前",
       "shares": 0,
       "content": "塞纳河畔 左岸的咖啡 我手一杯 品尝你的美 留下唇印的嘴 花店玫瑰 名字写错谁 告白气球 风吹到对街 微笑在天上飞 你说你有点难追 想让我知难而退 礼物不需挑最贵 只要香榭的落叶 喔 营造浪漫的约会 不害怕搞砸一切",
     ...
     },
     {
       ...
       "time": "14小时前",
       "shares": 0,
       "content": "我分享一个最近热潮的小程序段子： APP 如原配，一年不用几次；  服务号如情人，一个月固定几次；  订阅号如酒店小卡片，天天可以卖广告；  小程序像炮友，用完就走。",
     ...
     },
     {
       ...
       "time": "15小时前",
       "shares": 1,
       "content": "郭少分享一个关于小程序的段子： APP 如原配，一年不用几次；  服务号如情人，一个月固定几次；  订阅号如酒店小卡片，天天可以卖广告；  小程序像炮友，用完就走。",
   ...
   that.setData({
     ...
     'info.hasMore': true,
     'loading.hidden': true,
     'info.list': that.data.info.list.concat(data),
     'info.hidden': false
   })
  },
  initData: function () {
    ...
    var result = {
      "data": [
        ...
        },
        {
          ...
          "likes": 897,
          "content": "爱，不是寻找一个完美的人，而是学会用完美的眼光，欣赏那个并不完美的人。  因为爱你，只要你一个肯定，我就足够勇敢。",
          "name": "哈尔的移动城堡",
          "time": "3天前",
